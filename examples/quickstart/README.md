...
| artifactLocation | No | S3 key prefix for the Quick Start assets. Quick Start key prefix can include numbers, lowercase letters, uppercase letters, hyphens (-), and forward slash (/). |
...
| vip1PublicUrl | Url to public application address | Dag Module | string |
...
<a href="https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=BigIp-Quickstart-Example&templateURL=https://f5-cft-v2.s3.amazonaws.com/f5-aws-cloudformation-v2/v0.0.0.1/examples/quickstart/quickstart.yaml">
...
*Step 2: Specify stack details* 
  - Fill in the *REQUIRED* parameters. ex.
    - **sshKey**
