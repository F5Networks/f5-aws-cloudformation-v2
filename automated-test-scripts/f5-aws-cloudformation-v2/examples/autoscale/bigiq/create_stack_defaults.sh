...
curl https://f5-cft-v2.s3.amazonaws.com/${artifact_location}autoscale/bigip-configurations/runtime-init-conf-bigiq-with-app.yaml -o <DEWPOINT JOB ID>-config.yaml
